...
def start(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('𝐒𝐔𝐏𝐏𝐎𝐑𝐓 👬', url='https://t.me/music_world02'),
                    InlineKeyboardButton('𝐀𝐃𝐃 𝐌𝐄 🤗', url='https://t.me/MUSIC_WORLD_MUSIC_BOT?startgroup=true')
                ]
            ]
        )
    )
